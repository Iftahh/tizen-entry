...
var drawMaze = function(maze) {
    ...
    for (var i=0; i<maze.rooms.length; i++) {
        ...
        ctx.fillRect(10+2*room.x*cellWidth, 10+2*room.y*cellWidth, 2*room.w*cellWidth, 2*room.h*cellWidth);
    }
...
var genMaze = function() {
    ...
    window.maze = maze_gen_cells(options);
