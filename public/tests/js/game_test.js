...
// Settings
    ...
    window.miniGame = new WhichSmallerSprite(2);

    window.character = new Character( 1730, 1250, miniGame);
    ...
    $('.level-choose').click(function() {
        ...
        miniGame.setLevel(lvl);
        miniGame.correct = miniGame.incorrect = miniGame.smaller = miniGame.larger = miniGame.equal = 0;
    })
...
//        }
        ...
        $('#debug_text').html("Life: "+character.life+"\n\nFrame " +character.player.currentFrame +"\n"
            + "Actions: "+JSON.stringify(inputEngine.actions, false, 4) +
            "\n\nScroller: \n"+
            "  "+scroller.__scrollLeft+ ",\n  "+scroller.__scrollTop+"\n"+
            "\n\n\nCorrects: "+miniGame.correct+ "\nIncorrects: "+miniGame.incorrect+
            "\n\nSmaller: "+miniGame.smaller+"\nEqual: "+miniGame.equal+"\nLarger: "+miniGame.larger);
