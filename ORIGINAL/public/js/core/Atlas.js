...
Atlas = Class.extend({
    ...
    parseAtlasDefinition: function (atlasJSON) {
        ...
        for (var key in parsed.frames) {
            ...
            //
            // YOUR CODE HERE
            cx -= sprite.sourceSize.w / 2 - sprite.spriteSourceSize.x - sprite.spriteSourceSize.w / 2;
            cy -= sprite.sourceSize.h - sprite.spriteSourceSize.y - sprite.spriteSourceSize.h / 2;
    ...
    getStats: function (name) {
        ...
        for (var i = 0; i < this.sprites.length; i++) {
            ...
            if (this.sprites[i].id === name) {
                ...
                this.spriteCache[name] = this.sprites[i];
    ...
    drawSprite: function(ctx, spritename, posX, posY) {
        var spt = this.getStats(spritename);
        if (spt && this.img)
            ctx.drawImage(this.img, spt.x, spt.y, spt.w, spt.h, posX + spt.cx, posY +spt.cy, spt.w, spt.h);
    }
});
